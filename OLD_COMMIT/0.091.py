...
recommender_ItemKNNCF.fit(topK= 5, shrink= 16, normalize=True)
...
class ScoresHybridRecommender(BaseRecommender):
    ...
    def fit(self, alpha = 0.5, beta=0.5,gamma=0.3):
        self.alpha = alpha      
        self.beta = beta
        self.gamma= gamma
...
scoreshybridrecommender = ScoresHybridRecommender(URM_train,recommender_object, RP3_rec, P3alpha)
scoreshybridrecommender.fit(alpha= 2.644579752147618, beta= 2.021675201558332, gamma= 0.5676982254790722)
print("RESULT TOTAL:")
