...
class DifferentLossScoresHybridRecommender(BaseRecommender):
    ...
    def _compute_item_score(self, user_id_array, items_to_compute=None):
        ...
        item_weights = item_weights_1 / norm_item_weights_1 * self.alpha + item_weights_2 / norm_item_weights_2 * (1- self.alpha) + item_weights_3 / norm_item_weights_3 * (1 - self.alpha -self.beta) 
...
Slim_Elasticnet.fit(l1_ratio= 0.011453254111306543, topK= 422, alpha= 0.0011524047751432808)
